    ...
    <div class="outer-box">
        ...
        <div class="input-box flex items-center">
            ...
            <div class="w-[50px] h-[44px]">
                <div class="w-[40px] h-[40px] rounded-[12px] flex items-center justify-center cursor-pointer" @click="askFun" style="background-color: rgb(148 163 184);">
