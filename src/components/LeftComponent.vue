<template>
    <div class="outer-box flex flex-col justify-between" ref="boxRef">
        <div>
            ...
            <div class="h-[48px] flex items-center item mt-[30px]" @click="clickTab(1)" :class="{active:clickIndex===1}" :style="{paddingLeft:isOpen?'20px':'10px',paddingRight:isOpen?'20px':'10px',}">
                <div>
            ...
            <div class="h-[48px] flex items-center item mt-[10px]" @click="clickTab(2)" :class="{active:clickIndex===2}" :style="{paddingLeft:isOpen?'20px':'10px',paddingRight:isOpen?'20px':'10px',}">
                <div>
...
const clickTab = function(n:number){
    clickIndex.value = n;
    emit('changeTab',n)
}
</script>
